...
public class RangeQueriesNonUniformDataBox3List3 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        long max = 1L << bits;
	        double lon1= 50.22734375;
	        double lat1= 35.87531083569679;
	        double lon2= 50.0273437;
	        double lat2= 35.8653108356967;
	        double maxlon=180d;
	        double minlon=-180d;
	        double maxlat=90d;
	        double minlat=-90d;
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_non_uniform_q9.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RangeQueriesNonUniformDataBox3List3");            
	 }
