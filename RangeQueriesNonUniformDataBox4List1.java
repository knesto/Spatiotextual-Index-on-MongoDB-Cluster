...
public class RangeQueriesNonUniformDataBox4List1 {
	
	 @Test
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        int port_no = 27017;
	        String host_name = "83.212.78.113", db_name = "mongodb", db_coll_name = "non_uniform_collection";
	        //hilbertcollection
	        ...
	        long max = 1L << bits;
	        double lon1= 70.12934375;
	        double lat1=  15.87831083569679;
	        double lon2= 70.02734375;
	        double lat2= 15.87531083569679;
	        double maxlon=180d;
	        double minlon=-180d;
	        double maxlat=90d;
	        double minlat=-90d;
	        String[] keywords = {"brigand","brightest","brighouse"};
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_non_uniform_q10.txt");
	   ...
	   // public static void main(String[] args) throws Exception {
	    ...
	    //	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.BoxRangeQueriesTest");            
	 //}
