...
public class RangeQueriesNonUniformDataBox4List2 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        double maxlat=90d;
	        double minlat=-90d;
	        String[] keywords = {"addressable","address","addling"};
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_non_uniform_q11.txt");
