...
public class RangeQueriesNonUniformDataBox4List3 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        double maxlat=90d;
	        double minlat=-90d;
	        String[] keywords = {"ablated","abjuring","able"};
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_non_uniform_q12.txt");
