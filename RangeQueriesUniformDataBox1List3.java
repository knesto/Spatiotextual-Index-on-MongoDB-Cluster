...
public class RangeQueriesUniformDataBox1List3 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        long max = 1L << bits;
	        double lon1=  22.13671875;
	        double lat1= 37.31512514748051;
	        double lon2= 30.11101125;
	        double lat2= 37.31644714748051;
	        double maxlon=180d;
	        double minlon=-180d;
	        double maxlat=90d;
	        double minlat=-90d;
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_uniform_q3.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RangeQueriesUniformDataBox1List3");            
	 }
