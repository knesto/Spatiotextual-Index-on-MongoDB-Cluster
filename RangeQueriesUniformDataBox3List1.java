...
public class RangeQueriesUniformDataBox3List1 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        double maxlat=90d;
	        double minlat=-90d;
	        String[] keywords = {"ace","accustom","accuser"};
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_uniform_q7.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RangeQueriesUniformDataBox3List1");            
	 }
