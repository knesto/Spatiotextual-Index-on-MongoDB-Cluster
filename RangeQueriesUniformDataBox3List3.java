...
public class RangeQueriesUniformDataBox3List3 {
	
	 @Test
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        int port_no = 27017;
	        String host_name = "localhost", db_name = "mongodb", db_coll_name = "uniform_collection";
	        //hilbertcollection
	        ...
	        long max = 1L << bits;
	        double lon1= 51.958203125;
	        double lat1= 44.77131167976407;
	        double lon2= 51.88906249999999;
	        double lat2= 44.93306116240612;
	        double maxlon=180d;
	        double minlon=-180d;
	        double maxlat=90d;
	        double minlat=-90d;
	        String[] keywords = {"abaft","abalone","abandon"};
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_uniform_q9.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RangeQueriesUniformDataBox3List3");            
	 }
