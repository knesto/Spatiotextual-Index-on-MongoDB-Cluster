...
public class RangeQueriesUniformDataBox4List3 {
	 ...
	 public void test1() throws Exception { 
		 // Mongodb initialization parameters.
	        ...
	        long max = 1L << bits;
	        double lon1=  35.955859375;
	        double lat1= 35.982170703266075;
	        double lon2= 35.1001953125;
	        double lat2= 36.1023764487364;
	        double maxlon=180d;
	        double minlon=-180d;
	        double maxlat=90d;
	        double minlat=-90d;
	       ...
	       FileOutputStream outputStream = new FileOutputStream("results_uniform_q12.txt");
	    ...
	    public static void main(String[] args) throws Exception {
	    	...
	    	org.junit.runner.JUnitCore.main("gr.unipi.geotextualindexing.sfc.RangeQueriesUniformDataBox4List3");            
	 }
